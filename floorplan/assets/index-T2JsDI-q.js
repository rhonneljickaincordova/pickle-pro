...
`)}const v1={[$_]:"Linear",[tx]:"Reinhard",[ex]:"Cineon",[nx]:"ACESFilmic",[ax]:"AgX",[sx]:"Neutral",[ix]:"Custom"};function S1(o,t){const i=v1[t];return i===void 0?(ce("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+o+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+o+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Bc=new $;function y1(){we.getLuminanceCoefficients(Bc);const o=Bc.x.toFixed(4),t=Bc.y.toFixed(4),i=Bc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${o}, ${t}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
...
}`,eA=[new $(1,0,0),new $(-1,0,0),new $(0,1,0),new $(0,-1,0),new $(0,0,1),new $(0,0,-1)],nA=[new $(0,-1,0),new $(0,-1,0),new $(0,0,1),new $(0,0,-1),new $(0,-1,0),new $(0,-1,0)],Y_=new tn,qo=new $,qh=new $;function iA(o,t,i){let s=new ep;const l=new de,u=new de,h=new an,d=new fM,m=new hM,p={},x=i.maxTextureSize,_={[rs]:ti,[ti]:rs,[Vi]:Vi},S=new Ki({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new de},radius:{value:4}},vertexShader:$1,fragmentShader:tA}),b=S.clone();b.defines.HORIZONTAL_PASS=1;const E=new Ei;E.setAttribute("position",new qi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const C=new Ae(E,S),y=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Gc;let v=this.type;this.render=function(G,P,K){if(y.enabled===!1||y.autoUpdate===!1&&y.needsUpdate===!1||G.length===0)return;G.type===QS&&(ce("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),G.type=Gc);const R=o.getRenderTarget(),D=o.getActiveCubeFace(),k=o.getActiveMipmapLevel(),Y=o.state;Y.setBlending(ya),Y.buffers.depth.getReversed()===!0?Y.buffers.color.setClear(0,0,0,0):Y.buffers.color.setClear(1,1,1,1),Y.buffers.depth.setTest(!0),Y.setScissorTest(!1);const j=v!==this.type;j&&P.traverse(function(ot){ot.material&&(Array.isArray(ot.material)?ot.material.forEach(lt=>lt.needsUpdate=!0):ot.material.needsUpdate=!0)});for(let ot=0,lt=G.length;ot<lt;ot++){const U=G[ot],H=U.shadow;if(H===void 0){ce("WebGLShadowMap:",U,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;l.copy(H.mapSize);const nt=H.getFrameExtents();if(l.multiply(nt),u.copy(H.mapSize),(l.x>x||l.y>x)&&(l.x>x&&(u.x=Math.floor(x/nt.x),l.x=u.x*nt.x,H.mapSize.x=u.x),l.y>x&&(u.y=Math.floor(x/nt.y),l.y=u.y*nt.y,H.mapSize.y=u.y)),H.map===null||j===!0){if(H.map!==null&&(H.map.depthTexture!==null&&(H.map.depthTexture.dispose(),H.map.depthTexture=null),H.map.dispose()),this.type===Yo){if(U.isPointLight){ce("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}H.map=new Wi(l.x,l.y,{format:Hr,type:ba,minFilter:Bn,magFilter:Bn,generateMipmaps:!1}),H.map.texture.name=U.name+".shadowMap",H.map.depthTexture=new tl(l.x,l.y,ki),H.map.depthTexture.name=U.name+".shadowMapDepth",H.map.depthTexture.format=Ea,H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=On,H.map.depthTexture.magFilter=On}else{U.isPointLight?(H.map=new Ex(l.x),H.map.depthTexture=new lM(l.x,Yi)):(H.map=new Wi(l.x,l.y),H.map.depthTexture=new tl(l.x,l.y,Yi)),H.map.depthTexture.name=U.name+".shadowMap",H.map.depthTexture.format=Ea;const yt=o.state.buffers.depth.getReversed();this.type===Gc?(H.map.depthTexture.compareFunction=yt?Qd:Kd,H.map.depthTexture.minFilter=Bn,H.map.depthTexture.magFilter=Bn):(H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=On,H.map.depthTexture.magFilter=On)}H.camera.updateProjectionMatrix()}const Et=H.map.isWebGLCubeRenderTarget?6:1;for(let yt=0;yt<Et;yt++){if(H.map.isWebGLCubeRenderTarget)o.setRenderTarget(H.map,yt),o.clear();else{yt===0&&(o.setRenderTarget(H.map),o.clear());const L=H.getViewport(yt);h.set(u.x*L.x,u.y*L.y,u.x*L.z,u.y*L.w),Y.viewport(h)}if(U.isPointLight){const L=H.camera,tt=H.matrix,dt=U.distance||L.far;dt!==L.far&&(L.far=dt,L.updateProjectionMatrix()),qo.setFromMatrixPosition(U.matrixWorld),L.position.copy(qo),qh.copy(L.position),qh.add(eA[yt]),L.up.copy(nA[yt]),L.lookAt(qh),L.updateMatrixWorld(),tt.makeTranslation(-qo.x,-qo.y,-qo.z),Y_.multiplyMatrices(L.projectionMatrix,L.matrixWorldInverse),H._frustum.setFromProjectionMatrix(Y_,L.coordinateSystem,L.reversedDepth)}else H.updateMatrices(U);s=H.getFrustum(),O(P,K,H.camera,U,this.type)}H.isPointLightShadow!==!0&&this.type===Yo&&F(H,K),H.needsUpdate=!1}v=this.type,y.needsUpdate=!1,o.setRenderTarget(R,D,k)};function F(G,P){const K=t.update(C);S.defines.VSM_SAMPLES!==G.blurSamples&&(S.defines.VSM_SAMPLES=G.blurSamples,b.defines.VSM_SAMPLES=G.blurSamples,S.needsUpdate=!0,b.needsUpdate=!0),G.mapPass===null&&(G.mapPass=new Wi(l.x,l.y,{format:Hr,type:ba})),S.uniforms.shadow_pass.value=G.map.depthTexture,S.uniforms.resolution.value=G.mapSize,S.uniforms.radius.value=G.radius,o.setRenderTarget(G.mapPass),o.clear(),o.renderBufferDirect(P,null,K,S,C,null),b.uniforms.shadow_pass.value=G.mapPass.texture,b.uniforms.resolution.value=G.mapSize,b.uniforms.radius.value=G.radius,o.setRenderTarget(G.map),o.clear(),o.renderBufferDirect(P,null,K,b,C,null)}function z(G,P,K,R){let D=null;const k=K.isPointLight===!0?G.customDistanceMaterial:G.customDepthMaterial;if(k!==void 0)D=k;else if(D=K.isPointLight===!0?m:d,o.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0||P.alphaToCoverage===!0){const Y=D.uuid,j=P.uuid;let ot=p[Y];ot===void 0&&(ot={},p[Y]=ot);let lt=ot[j];lt===void 0&&(lt=D.clone(),ot[j]=lt,P.addEventListener("dispose",B)),D=lt}if(D.visible=P.visible,D.wireframe=P.wireframe,R===Yo?D.side=P.shadowSide!==null?P.shadowSide:P.side:D.side=P.shadowSide!==null?P.shadowSide:_[P.side],D.alphaMap=P.alphaMap,D.alphaTest=P.alphaToCoverage===!0?.5:P.alphaTest,D.map=P.map,D.clipShadows=P.clipShadows,D.clippingPlanes=P.clippingPlanes,D.clipIntersection=P.clipIntersection,D.displacementMap=P.displacementMap,D.displacementScale=P.displacementScale,D.displacementBias=P.displacementBias,D.wireframeLinewidth=P.wireframeLinewidth,D.linewidth=P.linewidth,K.isPointLight===!0&&D.isMeshDistanceMaterial===!0){const Y=o.properties.get(D);Y.light=K}return D}function O(G,P,K,R,D){if(G.visible===!1)return;if(G.layers.test(P.layers)&&(G.isMesh||G.isLine||G.isPoints)&&(G.castShadow||G.receiveShadow&&D===Yo)&&(!G.frustumCulled||s.intersectsObject(G))){G.modelViewMatrix.multiplyMatrices(K.matrixWorldInverse,G.matrixWorld);const j=t.update(G),ot=G.material;if(Array.isArray(ot)){const lt=j.groups;for(let U=0,H=lt.length;U<H;U++){const nt=lt[U],Et=ot[nt.materialIndex];if(Et&&Et.visible){const yt=z(G,Et,R,D);G.onBeforeShadow(o,G,P,K,j,yt,nt),o.renderBufferDirect(K,null,j,yt,G,nt),G.onAfterShadow(o,G,P,K,j,yt,nt)}}}else if(ot.visible){const lt=z(G,ot,R,D);G.onBeforeShadow(o,G,P,K,j,lt,null),o.renderBufferDirect(K,null,j,lt,G,null),G.onAfterShadow(o,G,P,K,j,lt,null)}}const Y=G.children;for(let j=0,ot=Y.length;j<ot;j++)O(Y[j],P,K,R,D)}function B(G){G.target.removeEventListener("dispose",B);for(const K in p){const R=p[K],D=G.target.uuid;D in R&&(R[D].dispose(),delete R[D])}}}const aA={[Qh]:Jh,[$h]:nd,[td]:id,[Ir]:ed,[Jh]:Qh,[nd]:$h,[id]:td,[ed]:Ir};function sA(o,t){function i(){let X=!1;const wt=new an;let Tt=null;const Ot=new an(0,0,0,0);return{setMask:function(St){Tt!==St&&!X&&(o.colorMask(St,St,St,St),Tt=St)},setLocked:function(St){X=St},setClear:function(St,gt,Dt,ue,Ie){Ie===!0&&(St*=ue,gt*=ue,Dt*=ue),wt.set(St,gt,Dt,ue),Ot.equals(wt)===!1&&(o.clearColor(St,gt,Dt,ue),Ot.copy(wt))},reset:function(){X=!1,Tt=null,Ot.set(-1,0,0,0)}}}function s(){let X=!1,wt=!1,Tt=null,Ot=null,St=null;return{setReversed:function(gt){if(wt!==gt){const Dt=t.get("EXT_clip_control");gt?Dt.clipControlEXT(Dt.LOWER_LEFT_EXT,Dt.ZERO_TO_ONE_EXT):Dt.clipControlEXT(Dt.LOWER_LEFT_EXT,Dt.NEGATIVE_ONE_TO_ONE_EXT),wt=gt;const ue=St;St=null,this.setClear(ue)}},getReversed:function(){return wt},setTest:function(gt){gt?ft(o.DEPTH_TEST):It(o.DEPTH_TEST)},setMask:function(gt){Tt!==gt&&!X&&(o.depthMask(gt),Tt=gt)},setFunc:function(gt){if(wt&&(gt=aA[gt]),Ot!==gt){switch(gt){case Qh:o.depthFunc(o.NEVER);break;case Jh:o.depthFunc(o.ALWAYS);break;case $h:o.depthFunc(o.LESS);break;case Ir:o.depthFunc(o.LEQUAL);break;case td:o.depthFunc(o.EQUAL);break;case ed:o.depthFunc(o.GEQUAL);break;case nd:o.depthFunc(o.GREATER);break;case id:o.depthFunc(o.NOTEQUAL);break;default:o.depthFunc(o.LEQUAL)}Ot=gt}},setLocked:function(gt){X=gt},setClear:function(gt){St!==gt&&(wt&&(gt=1-gt),o.clearDepth(gt),St=gt)},reset:function(){X=!1,Tt=null,Ot=null,St=null,wt=!1}}}function l(){let X=!1,wt=null,Tt=null,Ot=null,St=null,gt=null,Dt=null,ue=null,Ie=null;return{setTest:function(Ce){X||(Ce?ft(o.STENCIL_TEST):It(o.STENCIL_TEST))},setMask:function(Ce){wt!==Ce&&!X&&(o.stencilMask(Ce),wt=Ce)},setFunc:function(Ce,Pn,Ti){(Tt!==Ce||Ot!==Pn||St!==Ti)&&(o.stencilFunc(Ce,Pn,Ti),Tt=Ce,Ot=Pn,St=Ti)},setOp:function(Ce,Pn,Ti){(gt!==Ce||Dt!==Pn||ue!==Ti)&&(o.stencilOp(Ce,Pn,Ti),gt=Ce,Dt=Pn,ue=Ti)},setLocked:function(Ce){X=Ce},setClear:function(Ce){Ie!==Ce&&(o.clearStencil(Ce),Ie=Ce)},reset:function(){X=!1,wt=null,Tt=null,Ot=null,St=null,gt=null,Dt=null,ue=null,Ie=null}}}const u=new i,h=new s,d=new l,m=new WeakMap,p=new WeakMap;let x={},_={},S=new WeakMap,b=[],E=null,C=!1,y=null,v=null,F=null,z=null,O=null,B=null,G=null,P=new De(0,0,0),K=0,R=!1,D=null,k=null,Y=null,j=null,ot=null;const lt=o.getParameter(o.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let U=!1,H=0;const nt=o.getParameter(o.VERSION);nt.indexOf("WebGL")!==-1?(H=parseFloat(/^WebGL (\d)/.exec(nt)[1]),U=H>=1):nt.indexOf("OpenGL ES")!==-1&&(H=parseFloat(/^OpenGL ES (\d)/.exec(nt)[1]),U=H>=2);let Et=null,yt={};const L=o.getParameter(o.SCISSOR_BOX),tt=o.getParameter(o.VIEWPORT),dt=new an().fromArray(L),xt=new an().fromArray(tt);function Bt(X,wt,Tt,Ot){const St=new Uint8Array(4),gt=o.createTexture();o.bindTexture(X,gt),o.texParameteri(X,o.TEXTURE_MIN_FILTER,o.NEAREST),o.texParameteri(X,o.TEXTURE_MAG_FILTER,o.NEAREST);for(let Dt=0;Dt<Tt;Dt++)X===o.TEXTURE_3D||X===o.TEXTURE_2D_ARRAY?o.texImage3D(wt,0,o.RGBA,1,1,Ot,0,o.RGBA,o.UNSIGNED_BYTE,St):o.texImage2D(wt+Dt,0,o.RGBA,1,1,0,o.RGBA,o.UNSIGNED_BYTE,St);return gt}const at={};at[o.TEXTURE_2D]=Bt(o.TEXTURE_2D,o.TEXTURE_2D,1),at[o.TEXTURE_CUBE_MAP]=Bt(o.TEXTURE_CUBE_MAP,o.TEXTURE_CUBE_MAP_POSITIVE_X,6),at[o.TEXTURE_2D_ARRAY]=Bt(o.TEXTURE_2D_ARRAY,o.TEXTURE_2D_ARRAY,1,1),at[o.TEXTURE_3D]=Bt(o.TEXTURE_3D,o.TEXTURE_3D,1,1),u.setClear(0,0,0,1),h.setClear(1),d.setClear(0),ft(o.DEPTH_TEST),h.setFunc(Ir),Ut(!1),Ft(qg),ft(o.CULL_FACE),pe(ya);function ft(X){x[X]!==!0&&(o.enable(X),x[X]=!0)}function It(X){x[X]!==!1&&(o.disable(X),x[X]=!1)}function zt(X,wt){return _[X]!==wt?(o.bindFramebuffer(X,wt),_[X]=wt,X===o.DRAW_FRAMEBUFFER&&(_[o.FRAMEBUFFER]=wt),X===o.FRAMEBUFFER&&(_[o.DRAW_FRAMEBUFFER]=wt),!0):!1}function Gt(X,wt){let Tt=b,Ot=!1;if(X){Tt=S.get(wt),Tt===void 0&&(Tt=[],S.set(wt,Tt));const St=X.textures;if(Tt.length!==St.length||Tt[0]!==o.COLOR_ATTACHMENT0){for(let gt=0,Dt=St.length;gt<Dt;gt++)Tt[gt]=o.COLOR_ATTACHMENT0+gt;Tt.length=St.length,Ot=!0}}else Tt[0]!==o.BACK&&(Tt[0]=o.BACK,Ot=!0);Ot&&o.drawBuffers(Tt)}function le(X){return E!==X?(o.useProgram(X),E=X,!0):!1}const qe={[Ns]:o.FUNC_ADD,[$S]:o.FUNC_SUBTRACT,[ty]:o.FUNC_REVERSE_SUBTRACT};qe[ey]=o.MIN,qe[ny]=o.MAX;const ge={[iy]:o.ZERO,[ay]:o.ONE,[sy]:o.SRC_COLOR,[Zh]:o.SRC_ALPHA,[fy]:o.SRC_ALPHA_SATURATE,[cy]:o.DST_COLOR,[oy]:o.DST_ALPHA,[ry]:o.ONE_MINUS_SRC_COLOR,[Kh]:o.ONE_MINUS_SRC_ALPHA,[uy]:o.ONE_MINUS_DST_COLOR,[ly]:o.ONE_MINUS_DST_ALPHA,[hy]:o.CONSTANT_COLOR,[dy]:o.ONE_MINUS_CONSTANT_COLOR,[py]:o.CONSTANT_ALPHA,[my]:o.ONE_MINUS_CONSTANT_ALPHA};function pe(X,wt,Tt,Ot,St,gt,Dt,ue,Ie,Ce){if(X===ya){C===!0&&(It(o.BLEND),C=!1);return}if(C===!1&&(ft(o.BLEND),C=!0),X!==JS){if(X!==y||Ce!==R){if((v!==Ns||O!==Ns)&&(o.blendEquation(o.FUNC_ADD),v=Ns,O=Ns),Ce)switch(X){case zr:o.blendFuncSeparate(o.ONE,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case Yg:o.blendFunc(o.ONE,o.ONE);break;case Zg:o.blendFuncSeparate(o.ZERO,o.ONE_MINUS_SRC_COLOR,o.ZERO,o.ONE);break;case Kg:o.blendFuncSeparate(o.DST_COLOR,o.ONE_MINUS_SRC_ALPHA,o.ZERO,o.ONE);break;default:Le("WebGLState: Invalid blending: ",X);break}else switch(X){case zr:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case Yg:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE,o.ONE,o.ONE);break;case Zg:Le("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Kg:Le("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Le("WebGLState: Invalid blending: ",X);break}F=null,z=null,B=null,G=null,P.set(0,0,0),K=0,y=X,R=Ce}return}St=St||wt,gt=gt||Tt,Dt=Dt||Ot,(wt!==v||St!==O)&&(o.blendEquationSeparate(qe[wt],qe[St]),v=wt,O=St),(Tt!==F||Ot!==z||gt!==B||Dt!==G)&&(o.blendFuncSeparate(ge[Tt],ge[Ot],ge[gt],ge[Dt]),F=Tt,z=Ot,B=gt,G=Dt),(ue.equals(P)===!1||Ie!==K)&&(o.blendColor(ue.r,ue.g,ue.b,Ie),P.copy(ue),K=Ie),y=X,R=!1}function Re(X,wt){X.side===Vi?It(o.CULL_FACE):ft(o.CULL_FACE);let Tt=X.side===ti;wt&&(Tt=!Tt),Ut(Tt),X.blending===zr&&X.transparent===!1?pe(ya):pe(X.blending,X.blendEquation,X.blendSrc,X.blendDst,X.blendEquationAlpha,X.blendSrcAlpha,X.blendDstAlpha,X.blendColor,X.blendAlpha,X.premultipliedAlpha),h.setFunc(X.depthFunc),h.setTest(X.depthTest),h.setMask(X.depthWrite),u.setMask(X.colorWrite);const Ot=X.stencilWrite;d.setTest(Ot),Ot&&(d.setMask(X.stencilWriteMask),d.setFunc(X.stencilFunc,X.stencilRef,X.stencilFuncMask),d.setOp(X.stencilFail,X.stencilZFail,X.stencilZPass)),ie(X.polygonOffset,X.polygonOffsetFactor,X.polygonOffsetUnits),X.alphaToCoverage===!0?ft(o.SAMPLE_ALPHA_TO_COVERAGE):It(o.SAMPLE_ALPHA_TO_COVERAGE)}function Ut(X){D!==X&&(X?o.frontFace(o.CW):o.frontFace(o.CCW),D=X)}function Ft(X){X!==ZS?(ft(o.CULL_FACE),X!==k&&(X===qg?o.cullFace(o.BACK):X===KS?o.cullFace(o.FRONT):o.cullFace(o.FRONT_AND_BACK))):It(o.CULL_FACE),k=X}function I(X){X!==Y&&(U&&o.lineWidth(X),Y=X)}function ie(X,wt,Tt){X?(ft(o.POLYGON_OFFSET_FILL),(j!==wt||ot!==Tt)&&(o.polygonOffset(wt,Tt),j=wt,ot=Tt)):It(o.POLYGON_OFFSET_FILL)}function Xt(X){X?ft(o.SCISSOR_TEST):It(o.SCISSOR_TEST)}function Yt(X){X===void 0&&(X=o.TEXTURE0+lt-1),Et!==X&&(o.activeTexture(X),Et=X)}function Wt(X,wt,Tt){Tt===void 0&&(Et===null?Tt=o.TEXTURE0+lt-1:Tt=Et);let Ot=yt[Tt];Ot===void 0&&(Ot={type:void 0,texture:void 0},yt[Tt]=Ot),(Ot.type!==X||Ot.texture!==wt)&&(Et!==Tt&&(o.activeTexture(Tt),Et=Tt),o.bindTexture(X,wt||at[X]),Ot.type=X,Ot.texture=wt)}function N(){const X=yt[Et];X!==void 0&&X.type!==void 0&&(o.bindTexture(X.type,null),X.type=void 0,X.texture=void 0)}function M(){try{o.compressedTexImage2D(...arguments)}catch(X){Le("WebGLState:",X)}}function q(){try{o.compressedTexImage3D(...arguments)}catch(X){Le("WebGLState:",X)}}function pt(){try{o.texSubImage2D(...arguments)}catch(X){Le("WebGLState:",X)}}function bt(){try{o.texSubImage3D(...arguments)}catch(X){Le("WebGLState:",X)}}function ht(){try{o.compressedTexSubImage2D(...arguments)}catch(X){Le("WebGLState:",X)}}function Qt(){try{o.compressedTexSubImage3D(...arguments)}catch(X){Le("WebGLState:",X)}}function Rt(){try{o.texStorage2D(...arguments)}catch(X){Le("WebGLState:",X)}}function Nt(){try{o.texStorage3D(...arguments)}catch(X){Le("WebGLState:",X)}}function Vt(){try{o.texImage2D(...arguments)}catch(X){Le("WebGLState:",X)}}function Mt(){try{o.texImage3D(...arguments)}catch(X){Le("WebGLState:",X)}}function At(X){dt.equals(X)===!1&&(o.scissor(X.x,X.y,X.z,X.w),dt.copy(X))}function Pt(X){xt.equals(X)===!1&&(o.viewport(X.x,X.y,X.z,X.w),xt.copy(X))}function Lt(X,wt){let Tt=p.get(wt);Tt===void 0&&(Tt=new WeakMap,p.set(wt,Tt));let Ot=Tt.get(X);Ot===void 0&&(Ot=o.getUniformBlockIndex(wt,X.name),Tt.set(X,Ot))}function Ct(X,wt){const Ot=p.get(wt).get(X);m.get(wt)!==Ot&&(o.uniformBlockBinding(wt,Ot,X.__bindingPointIndex),m.set(wt,Ot))}function ae(){o.disable(o.BLEND),o.disable(o.CULL_FACE),o.disable(o.DEPTH_TEST),o.disable(o.POLYGON_OFFSET_FILL),o.disable(o.SCISSOR_TEST),o.disable(o.STENCIL_TEST),o.disable(o.SAMPLE_ALPHA_TO_COVERAGE),o.blendEquation(o.FUNC_ADD),o.blendFunc(o.ONE,o.ZERO),o.blendFuncSeparate(o.ONE,o.ZERO,o.ONE,o.ZERO),o.blendColor(0,0,0,0),o.colorMask(!0,!0,!0,!0),o.clearColor(0,0,0,0),o.depthMask(!0),o.depthFunc(o.LESS),h.setReversed(!1),o.clearDepth(1),o.stencilMask(4294967295),o.stencilFunc(o.ALWAYS,0,4294967295),o.stencilOp(o.KEEP,o.KEEP,o.KEEP),o.clearStencil(0),o.cullFace(o.BACK),o.frontFace(o.CCW),o.polygonOffset(0,0),o.activeTexture(o.TEXTURE0),o.bindFramebuffer(o.FRAMEBUFFER,null),o.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),o.bindFramebuffer(o.READ_FRAMEBUFFER,null),o.useProgram(null),o.lineWidth(1),o.scissor(0,0,o.canvas.width,o.canvas.height),o.viewport(0,0,o.canvas.width,o.canvas.height),x={},Et=null,yt={},_={},S=new WeakMap,b=[],E=null,C=!1,y=null,v=null,F=null,z=null,O=null,B=null,G=null,P=new De(0,0,0),K=0,R=!1,D=null,k=null,Y=null,j=null,ot=null,dt.set(0,0,o.canvas.width,o.canvas.height),xt.set(0,0,o.canvas.width,o.canvas.height),u.reset(),h.reset(),d.reset()}return{buffers:{color:u,depth:h,stencil:d},enable:ft,disable:It,bindFramebuffer:zt,drawBuffers:Gt,useProgram:le,setBlending:pe,setMaterial:Re,setFlipSided:Ut,setCullFace:Ft,setLineWidth:I,setPolygonOffset:ie,setScissorTest:Xt,activeTexture:Yt,bindTexture:Wt,unbindTexture:N,compressedTexImage2D:M,compressedTexImage3D:q,texImage2D:Vt,texImage3D:Mt,updateUBOMapping:Lt,uniformBlockBinding:Ct,texStorage2D:Rt,texStorage3D:Nt,texSubImage2D:pt,texSubImage3D:bt,compressedTexSubImage2D:ht,compressedTexSubImage3D:Qt,scissor:At,viewport:Pt,reset:ae}}function rA(o,t,i,s,l,u,h){const d=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new de,x=new WeakMap;let _;const S=new WeakMap;let b=!1;try{b=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function E(N,M){return b?new OffscreenCanvas(N,M):Zc("canvas")}function C(N,M,q){let pt=1;const bt=Wt(N);if((bt.width>q||bt.height>q)&&(pt=q/Math.max(bt.width,bt.height)),pt<1)if(typeof HTMLImageElement<"u"&&N instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&N instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&N instanceof ImageBitmap||typeof VideoFrame<"u"&&N instanceof VideoFrame){const ht=Math.floor(pt*bt.width),Qt=Math.floor(pt*bt.height);_===void 0&&(_=E(ht,Qt));const Rt=M?E(ht,Qt):_;return Rt.width=ht,Rt.height=Qt,Rt.getContext("2d").drawImage(N,0,0,ht,Qt),ce("WebGLRenderer: Texture has been resized from ("+bt.width+"x"+bt.height+") to ("+ht+"x"+Qt+")."),Rt}else return"data"in N&&ce("WebGLRenderer: Image in DataTexture is too big ("+bt.width+"x"+bt.height+")."),N;return N}function y(N){return N.generateMipmaps}function v(N){o.generateMipmap(N)}function F(N){return N.isWebGLCubeRenderTarget?o.TEXTURE_CUBE_MAP:N.isWebGL3DRenderTarget?o.TEXTURE_3D:N.isWebGLArrayRenderTarget||N.isCompressedArrayTexture?o.TEXTURE_2D_ARRAY:o.TEXTURE_2D}function z(N,M,q,pt,bt=!1){if(N!==null){if(o[N]!==void 0)return o[N];ce("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+N+"'")}let ht=M;if(M===o.RED&&(q===o.FLOAT&&(ht=o.R32F),q===o.HALF_FLOAT&&(ht=o.R16F),q===o.UNSIGNED_BYTE&&(ht=o.R8)),M===o.RED_INTEGER&&(q===o.UNSIGNED_BYTE&&(ht=o.R8UI),q===o.UNSIGNED_SHORT&&(ht=o.R16UI),q===o.UNSIGNED_INT&&(ht=o.R32UI),q===o.BYTE&&(ht=o.R8I),q===o.SHORT&&(ht=o.R16I),q===o.INT&&(ht=o.R32I)),M===o.RG&&(q===o.FLOAT&&(ht=o.RG32F),q===o.HALF_FLOAT&&(ht=o.RG16F),q===o.UNSIGNED_BYTE&&(ht=o.RG8)),M===o.RG_INTEGER&&(q===o.UNSIGNED_BYTE&&(ht=o.RG8UI),q===o.UNSIGNED_SHORT&&(ht=o.RG16UI),q===o.UNSIGNED_INT&&(ht=o.RG32UI),q===o.BYTE&&(ht=o.RG8I),q===o.SHORT&&(ht=o.RG16I),q===o.INT&&(ht=o.RG32I)),M===o.RGB_INTEGER&&(q===o.UNSIGNED_BYTE&&(ht=o.RGB8UI),q===o.UNSIGNED_SHORT&&(ht=o.RGB16UI),q===o.UNSIGNED_INT&&(ht=o.RGB32UI),q===o.BYTE&&(ht=o.RGB8I),q===o.SHORT&&(ht=o.RGB16I),q===o.INT&&(ht=o.RGB32I)),M===o.RGBA_INTEGER&&(q===o.UNSIGNED_BYTE&&(ht=o.RGBA8UI),q===o.UNSIGNED_SHORT&&(ht=o.RGBA16UI),q===o.UNSIGNED_INT&&(ht=o.RGBA32UI),q===o.BYTE&&(ht=o.RGBA8I),q===o.SHORT&&(ht=o.RGBA16I),q===o.INT&&(ht=o.RGBA32I)),M===o.RGB&&(q===o.UNSIGNED_INT_5_9_9_9_REV&&(ht=o.RGB9_E5),q===o.UNSIGNED_INT_10F_11F_11F_REV&&(ht=o.R11F_G11F_B10F)),M===o.RGBA){const Qt=bt?qc:we.getTransfer(pt);q===o.FLOAT&&(ht=o.RGBA32F),q===o.HALF_FLOAT&&(ht=o.RGBA16F),q===o.UNSIGNED_BYTE&&(ht=Qt===Ve?o.SRGB8_ALPHA8:o.RGBA8),q===o.UNSIGNED_SHORT_4_4_4_4&&(ht=o.RGBA4),q===o.UNSIGNED_SHORT_5_5_5_1&&(ht=o.RGB5_A1)}return(ht===o.R16F||ht===o.R32F||ht===o.RG16F||ht===o.RG32F||ht===o.RGBA16F||ht===o.RGBA32F)&&t.get("EXT_color_buffer_float"),ht}function O(N,M){let q;return N?M===null||M===Yi||M===Jo?q=o.DEPTH24_STENCIL8:M===ki?q=o.DEPTH32F_STENCIL8:M===Qo&&(q=o.DEPTH24_STENCIL8,ce("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===Yi||M===Jo?q=o.DEPTH_COMPONENT24:M===ki?q=o.DEPTH_COMPONENT32F:M===Qo&&(q=o.DEPTH_COMPONENT16),q}function B(N,M){return y(N)===!0||N.isFramebufferTexture&&N.minFilter!==On&&N.minFilter!==Bn?Math.log2(Math.max(M.width,M.height))+1:N.mipmaps!==void 0&&N.mipmaps.length>0?N.mipmaps.length:N.isCompressedTexture&&Array.isArray(N.image)?M.mipmaps.length:1}function G(N){const M=N.target;M.removeEventListener("dispose",G),K(M),M.isVideoTexture&&x.delete(M)}function P(N){const M=N.target;M.removeEventListener("dispose",P),D(M)}function K(N){const M=s.get(N);if(M.__webglInit===void 0)return;const q=N.source,pt=S.get(q);if(pt){const bt=pt[M.__cacheKey];bt.usedTimes--,bt.usedTimes===0&&R(N),Object.keys(pt).length===0&&S.delete(q)}s.remove(N)}function R(N){const M=s.get(N);o.deleteTexture(M.__webglTexture);const q=N.source,pt=S.get(q);delete pt[M.__cacheKey],h.memory.textures--}function D(N){const M=s.get(N);if(N.depthTexture&&(N.depthTexture.dispose(),s.remove(N.depthTexture)),N.isWebGLCubeRenderTarget)for(let pt=0;pt<6;pt++){if(Array.isArray(M.__webglFramebuffer[pt]))for(let bt=0;bt<M.__webglFramebuffer[pt].length;bt++)o.deleteFramebuffer(M.__webglFramebuffer[pt][bt]);else o.deleteFramebuffer(M.__webglFramebuffer[pt]);M.__webglDepthbuffer&&o.deleteRenderbuffer(M.__webglDepthbuffer[pt])}else{if(Array.isArray(M.__webglFramebuffer))for(let pt=0;pt<M.__webglFramebuffer.length;pt++)o.deleteFramebuffer(M.__webglFramebuffer[pt]);else o.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&o.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&o.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let pt=0;pt<M.__webglColorRenderbuffer.length;pt++)M.__webglColorRenderbuffer[pt]&&o.deleteRenderbuffer(M.__webglColorRenderbuffer[pt]);M.__webglDepthRenderbuffer&&o.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const q=N.textures;for(let pt=0,bt=q.length;pt<bt;pt++){const ht=s.get(q[pt]);ht.__webglTexture&&(o.deleteTexture(ht.__webglTexture),h.memory.textures--),s.remove(q[pt])}s.remove(N)}let k=0;function Y(){k=0}function j(){const N=k;return N>=l.maxTextures&&ce("WebGLTextures: Trying to use "+N+" texture units while this GPU supports only "+l.maxTextures),k+=1,N}function ot(N){const M=[];return M.push(N.wrapS),M.push(N.wrapT),M.push(N.wrapR||0),M.push(N.magFilter),M.push(N.minFilter),M.push(N.anisotropy),M.push(N.internalFormat),M.push(N.format),M.push(N.type),M.push(N.generateMipmaps),M.push(N.premultiplyAlpha),M.push(N.flipY),M.push(N.unpackAlignment),M.push(N.colorSpace),M.join()}function lt(N,M){const q=s.get(N);if(N.isVideoTexture&&Xt(N),N.isRenderTargetTexture===!1&&N.isExternalTexture!==!0&&N.version>0&&q.__version!==N.version){const pt=N.image;if(pt===null)ce("WebGLRenderer: Texture marked for update but no image data found.");else if(pt.complete===!1)ce("WebGLRenderer: Texture marked for update but image is incomplete");else{at(q,N,M);return}}else N.isExternalTexture&&(q.__webglTexture=N.sourceTexture?N.sourceTexture:null);i.bindTexture(o.TEXTURE_2D,q.__webglTexture,o.TEXTURE0+M)}function U(N,M){const q=s.get(N);if(N.isRenderTargetTexture===!1&&N.version>0&&q.__version!==N.version){at(q,N,M);return}else N.isExternalTexture&&(q.__webglTexture=N.sourceTexture?N.sourceTexture:null);i.bindTexture(o.TEXTURE_2D_ARRAY,q.__webglTexture,o.TEXTURE0+M)}function H(N,M){const q=s.get(N);if(N.isRenderTargetTexture===!1&&N.version>0&&q.__version!==N.version){at(q,N,M);return}i.bindTexture(o.TEXTURE_3D,q.__webglTexture,o.TEXTURE0+M)}function nt(N,M){const q=s.get(N);if(N.isCubeDepthTexture!==!0&&N.version>0&&q.__version!==N.version){ft(q,N,M);return}i.bindTexture(o.TEXTURE_CUBE_MAP,q.__webglTexture,o.TEXTURE0+M)}const Et={[rd]:o.REPEAT,[Sa]:o.CLAMP_TO_EDGE,[od]:o.MIRRORED_REPEAT},yt={[On]:o.NEAREST,[xy]:o.NEAREST_MIPMAP_NEAREST,[pc]:o.NEAREST_MIPMAP_LINEAR,[Bn]:o.LINEAR,[mh]:o.LINEAR_MIPMAP_NEAREST,[Ls]:o.LINEAR_MIPMAP_LINEAR},L={[yy]:o.NEVER,[Ay]:o.ALWAYS,[My]:o.LESS,[Kd]:o.LEQUAL,[by]:o.EQUAL,[Qd]:o.GEQUAL,[Ey]:o.GREATER,[Ty]:o.NOTEQUAL};function tt(N,M){if(M.type===ki&&t.has("OES_texture_float_linear")===!1&&(M.magFilter===Bn||M.magFilter===mh||M.magFilter===pc||M.magFilter===Ls||M.minFilter===Bn||M.minFilter===mh||M.minFilter===pc||M.minFilter===Ls)&&ce("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),o.texParameteri(N,o.TEXTURE_WRAP_S,Et[M.wrapS]),o.texParameteri(N,o.TEXTURE_WRAP_T,Et[M.wrapT]),(N===o.TEXTURE_3D||N===o.TEXTURE_2D_ARRAY)&&o.texParameteri(N,o.TEXTURE_WRAP_R,Et[M.wrapR]),o.texParameteri(N,o.TEXTURE_MAG_FILTER,yt[M.magFilter]),o.texParameteri(N,o.TEXTURE_MIN_FILTER,yt[M.minFilter]),M.compareFunction&&(o.texParameteri(N,o.TEXTURE_COMPARE_MODE,o.COMPARE_REF_TO_TEXTURE),o.texParameteri(N,o.TEXTURE_COMPARE_FUNC,L[M.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===On||M.minFilter!==pc&&M.minFilter!==Ls||M.type===ki&&t.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||s.get(M).__currentAnisotropy){const q=t.get("EXT_texture_filter_anisotropic");o.texParameterf(N,q.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,l.getMaxAnisotropy())),s.get(M).__currentAnisotropy=M.anisotropy}}}function dt(N,M){let q=!1;N.__webglInit===void 0&&(N.__webglInit=!0,M.addEventListener("dispose",G));const pt=M.source;let bt=S.get(pt);bt===void 0&&(bt={},S.set(pt,bt));const ht=ot(M);if(ht!==N.__cacheKey){bt[ht]===void 0&&(bt[ht]={texture:o.createTexture(),usedTimes:0},h.memory.textures++,q=!0),bt[ht].usedTimes++;const Qt=bt[N.__cacheKey];Qt!==void 0&&(bt[N.__cacheKey].usedTimes--,Qt.usedTimes===0&&R(M)),N.__cacheKey=ht,N.__webglTexture=bt[ht].texture}return q}function xt(N,M,q){return Math.floor(Math.floor(N/q)/M)}function Bt(N,M,q,pt){const ht=N.updateRanges;if(ht.length===0)i.texSubImage2D(o.TEXTURE_2D,0,0,0,M.width,M.height,q,pt,M.data);else{ht.sort((Mt,At)=>Mt.start-At.start);let Qt=0;for(let Mt=1;Mt<ht.length;Mt++){const At=ht[Qt],Pt=ht[Mt],Lt=At.start+At.count,Ct=xt(Pt.start,M.width,4),ae=xt(At.start,M.width,4);Pt.start<=Lt+1&&Ct===ae&&xt(Pt.start+Pt.count-1,M.width,4)===Ct?At.count=Math.max(At.count,Pt.start+Pt.count-At.start):(++Qt,ht[Qt]=Pt)}ht.length=Qt+1;const Rt=o.getParameter(o.UNPACK_ROW_LENGTH),Nt=o.getParameter(o.UNPACK_SKIP_PIXELS),Vt=o.getParameter(o.UNPACK_SKIP_ROWS);o.pixelStorei(o.UNPACK_ROW_LENGTH,M.width);for(let Mt=0,At=ht.length;Mt<At;Mt++){const Pt=ht[Mt],Lt=Math.floor(Pt.start/4),Ct=Math.ceil(Pt.count/4),ae=Lt%M.width,X=Math.floor(Lt/M.width),wt=Ct,Tt=1;o.pixelStorei(o.UNPACK_SKIP_PIXELS,ae),o.pixelStorei(o.UNPACK_SKIP_ROWS,X),i.texSubImage2D(o.TEXTURE_2D,0,ae,X,wt,Tt,q,pt,M.data)}N.clearUpdateRanges(),o.pixelStorei(o.UNPACK_ROW_LENGTH,Rt),o.pixelStorei(o.UNPACK_SKIP_PIXELS,Nt),o.pixelStorei(o.UNPACK_SKIP_ROWS,Vt)}}function at(N,M,q){let pt=o.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(pt=o.TEXTURE_2D_ARRAY),M.isData3DTexture&&(pt=o.TEXTURE_3D);const bt=dt(N,M),ht=M.source;i.bindTexture(pt,N.__webglTexture,o.TEXTURE0+q);const Qt=s.get(ht);if(ht.version!==Qt.__version||bt===!0){i.activeTexture(o.TEXTURE0+q);const Rt=we.getPrimaries(we.workingColorSpace),Nt=M.colorSpace===as?null:we.getPrimaries(M.colorSpace),Vt=M.colorSpace===as||Rt===Nt?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,M.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,M.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,Vt);let Mt=C(M.image,!1,l.maxTextureSize);Mt=Yt(M,Mt);const At=u.convert(M.format,M.colorSpace),Pt=u.convert(M.type);let Lt=z(M.internalFormat,At,Pt,M.colorSpace,M.isVideoTexture);tt(pt,M);let Ct;const ae=M.mipmaps,X=M.isVideoTexture!==!0,wt=Qt.__version===void 0||bt===!0,Tt=ht.dataReady,Ot=B(M,Mt);if(M.isDepthTexture)Lt=O(M.format===Os,M.type),wt&&(X?i.texStorage2D(o.TEXTURE_2D,1,Lt,Mt.width,Mt.height):i.texImage2D(o.TEXTURE_2D,0,Lt,Mt.width,Mt.height,0,At,Pt,null));else if(M.isDataTexture)if(ae.length>0){X&&wt&&i.texStorage2D(o.TEXTURE_2D,Ot,Lt,ae[0].width,ae[0].height);for(let St=0,gt=ae.length;St<gt;St++)Ct=ae[St],X?Tt&&i.texSubImage2D(o.TEXTURE_2D,St,0,0,Ct.width,Ct.height,At,Pt,Ct.data):i.texImage2D(o.TEXTURE_2D,St,Lt,Ct.width,Ct.height,0,At,Pt,Ct.data);M.generateMipmaps=!1}else X?(wt&&i.texStorage2D(o.TEXTURE_2D,Ot,Lt,Mt.width,Mt.height),Tt&&Bt(M,Mt,At,Pt)):i.texImage2D(o.TEXTURE_2D,0,Lt,Mt.width,Mt.height,0,At,Pt,Mt.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){X&&wt&&i.texStorage3D(o.TEXTURE_2D_ARRAY,Ot,Lt,ae[0].width,ae[0].height,Mt.depth);for(let St=0,gt=ae.length;St<gt;St++)if(Ct=ae[St],M.format!==Oi)if(At!==null)if(X){if(Tt)if(M.layerUpdates.size>0){const Dt=T_(Ct.width,Ct.height,M.format,M.type);for(const ue of M.layerUpdates){const Ie=Ct.data.subarray(ue*Dt/Ct.data.BYTES_PER_ELEMENT,(ue+1)*Dt/Ct.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,St,0,0,ue,Ct.width,Ct.height,1,At,Ie)}M.clearLayerUpdates()}else i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,St,0,0,0,Ct.width,Ct.height,Mt.depth,At,Ct.data)}else i.compressedTexImage3D(o.TEXTURE_2D_ARRAY,St,Lt,Ct.width,Ct.height,Mt.depth,0,Ct.data,0,0);else ce("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else X?Tt&&i.texSubImage3D(o.TEXTURE_2D_ARRAY,St,0,0,0,Ct.width,Ct.height,Mt.depth,At,Pt,Ct.data):i.texImage3D(o.TEXTURE_2D_ARRAY,St,Lt,Ct.width,Ct.height,Mt.depth,0,At,Pt,Ct.data)}else{X&&wt&&i.texStorage2D(o.TEXTURE_2D,Ot,Lt,ae[0].width,ae[0].height);for(let St=0,gt=ae.length;St<gt;St++)Ct=ae[St],M.format!==Oi?At!==null?X?Tt&&i.compressedTexSubImage2D(o.TEXTURE_2D,St,0,0,Ct.width,Ct.height,At,Ct.data):i.compressedTexImage2D(o.TEXTURE_2D,St,Lt,Ct.width,Ct.height,0,Ct.data):ce("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):X?Tt&&i.texSubImage2D(o.TEXTURE_2D,St,0,0,Ct.width,Ct.height,At,Pt,Ct.data):i.texImage2D(o.TEXTURE_2D,St,Lt,Ct.width,Ct.height,0,At,Pt,Ct.data)}else if(M.isDataArrayTexture)if(X){if(wt&&i.texStorage3D(o.TEXTURE_2D_ARRAY,Ot,Lt,Mt.width,Mt.height,Mt.depth),Tt)if(M.layerUpdates.size>0){const St=T_(Mt.width,Mt.height,M.format,M.type);for(const gt of M.layerUpdates){const Dt=Mt.data.subarray(gt*St/Mt.data.BYTES_PER_ELEMENT,(gt+1)*St/Mt.data.BYTES_PER_ELEMENT);i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,gt,Mt.width,Mt.height,1,At,Pt,Dt)}M.clearLayerUpdates()}else i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,0,Mt.width,Mt.height,Mt.depth,At,Pt,Mt.data)}else i.texImage3D(o.TEXTURE_2D_ARRAY,0,Lt,Mt.width,Mt.height,Mt.depth,0,At,Pt,Mt.data);else if(M.isData3DTexture)X?(wt&&i.texStorage3D(o.TEXTURE_3D,Ot,Lt,Mt.width,Mt.height,Mt.depth),Tt&&i.texSubImage3D(o.TEXTURE_3D,0,0,0,0,Mt.width,Mt.height,Mt.depth,At,Pt,Mt.data)):i.texImage3D(o.TEXTURE_3D,0,Lt,Mt.width,Mt.height,Mt.depth,0,At,Pt,Mt.data);else if(M.isFramebufferTexture){if(wt)if(X)i.texStorage2D(o.TEXTURE_2D,Ot,Lt,Mt.width,Mt.height);else{let St=Mt.width,gt=Mt.height;for(let Dt=0;Dt<Ot;Dt++)i.texImage2D(o.TEXTURE_2D,Dt,Lt,St,gt,0,At,Pt,null),St>>=1,gt>>=1}}else if(ae.length>0){if(X&&wt){const St=Wt(ae[0]);i.texStorage2D(o.TEXTURE_2D,Ot,Lt,St.width,St.height)}for(let St=0,gt=ae.length;St<gt;St++)Ct=ae[St],X?Tt&&i.texSubImage2D(o.TEXTURE_2D,St,0,0,At,Pt,Ct):i.texImage2D(o.TEXTURE_2D,St,Lt,At,Pt,Ct);M.generateMipmaps=!1}else if(X){if(wt){const St=Wt(Mt);i.texStorage2D(o.TEXTURE_2D,Ot,Lt,St.width,St.height)}Tt&&i.texSubImage2D(o.TEXTURE_2D,0,0,0,At,Pt,Mt)}else i.texImage2D(o.TEXTURE_2D,0,Lt,At,Pt,Mt);y(M)&&v(pt),Qt.__version=ht.version,M.onUpdate&&M.onUpdate(M)}N.__version=M.version}function ft(N,M,q){if(M.image.length!==6)return;const pt=dt(N,M),bt=M.source;i.bindTexture(o.TEXTURE_CUBE_MAP,N.__webglTexture,o.TEXTURE0+q);const ht=s.get(bt);if(bt.version!==ht.__version||pt===!0){i.activeTexture(o.TEXTURE0+q);const Qt=we.getPrimaries(we.workingColorSpace),Rt=M.colorSpace===as?null:we.getPrimaries(M.colorSpace),Nt=M.colorSpace===as||Qt===Rt?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,M.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,M.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,Nt);const Vt=M.isCompressedTexture||M.image[0].isCompressedTexture,Mt=M.image[0]&&M.image[0].isDataTexture,At=[];for(let gt=0;gt<6;gt++)!Vt&&!Mt?At[gt]=C(M.image[gt],!0,l.maxCubemapSize):At[gt]=Mt?M.image[gt].image:M.image[gt],At[gt]=Yt(M,At[gt]);const Pt=At[0],Lt=u.convert(M.format,M.colorSpace),Ct=u.convert(M.type),ae=z(M.internalFormat,Lt,Ct,M.colorSpace),X=M.isVideoTexture!==!0,wt=ht.__version===void 0||pt===!0,Tt=bt.dataReady;let Ot=B(M,Pt);tt(o.TEXTURE_CUBE_MAP,M);let St;if(Vt){X&&wt&&i.texStorage2D(o.TEXTURE_CUBE_MAP,Ot,ae,Pt.width,Pt.height);for(let gt=0;gt<6;gt++){St=At[gt].mipmaps;for(let Dt=0;Dt<St.length;Dt++){const ue=St[Dt];M.format!==Oi?Lt!==null?X?Tt&&i.compressedTexSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+gt,Dt,0,0,ue.width,ue.height,Lt,ue.data):i.compressedTexImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+gt,Dt,ae,ue.width,ue.height,0,ue.data):ce("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):X?Tt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+gt,Dt,0,0,ue.width,ue.height,Lt,Ct,ue.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+gt,Dt,ae,ue.width,ue.height,0,Lt,Ct,ue.data)}}}else{if(St=M.mipmaps,X&&wt){St.length>0&&Ot++;const gt=Wt(At[0]);i.texStorage2D(o.TEXTURE_CUBE_MAP,Ot,ae,gt.width,gt.height)}for(let gt=0;gt<6;gt++)if(Mt){X?Tt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+gt,0,0,0,At[gt].width,At[gt].height,Lt,Ct,At[gt].data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+gt,0,ae,At[gt].width,At[gt].height,0,Lt,Ct,At[gt].data);for(let Dt=0;Dt<St.length;Dt++){const Ie=St[Dt].image[gt].image;X?Tt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+gt,Dt+1,0,0,Ie.width,Ie.height,Lt,Ct,Ie.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+gt,Dt+1,ae,Ie.width,Ie.height,0,Lt,Ct,Ie.data)}}else{X?Tt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+gt,0,0,0,Lt,Ct,At[gt]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+gt,0,ae,Lt,Ct,At[gt]);for(let Dt=0;Dt<St.length;Dt++){const ue=St[Dt];X?Tt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+gt,Dt+1,0,0,Lt,Ct,ue.image[gt]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+gt,Dt+1,ae,Lt,Ct,ue.image[gt])}}}y(M)&&v(o.TEXTURE_CUBE_MAP),ht.__version=bt.version,M.onUpdate&&M.onUpdate(M)}N.__version=M.version}function It(N,M,q,pt,bt,ht){const Qt=u.convert(q.format,q.colorSpace),Rt=u.convert(q.type),Nt=z(q.internalFormat,Qt,Rt,q.colorSpace),Vt=s.get(M),Mt=s.get(q);if(Mt.__renderTarget=M,!Vt.__hasExternalTextures){const At=Math.max(1,M.width>>ht),Pt=Math.max(1,M.height>>ht);bt===o.TEXTURE_3D||bt===o.TEXTURE_2D_ARRAY?i.texImage3D(bt,ht,Nt,At,Pt,M.depth,0,Qt,Rt,null):i.texImage2D(bt,ht,Nt,At,Pt,0,Qt,Rt,null)}i.bindFramebuffer(o.FRAMEBUFFER,N),ie(M)?d.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,pt,bt,Mt.__webglTexture,0,I(M)):(bt===o.TEXTURE_2D||bt>=o.TEXTURE_CUBE_MAP_POSITIVE_X&&bt<=o.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&o.framebufferTexture2D(o.FRAMEBUFFER,pt,bt,Mt.__webglTexture,ht),i.bindFramebuffer(o.FRAMEBUFFER,null)}function zt(N,M,q){if(o.bindRenderbuffer(o.RENDERBUFFER,N),M.depthBuffer){const pt=M.depthTexture,bt=pt&&pt.isDepthTexture?pt.type:null,ht=O(M.stencilBuffer,bt),Qt=M.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT;ie(M)?d.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,I(M),ht,M.width,M.height):q?o.renderbufferStorageMultisample(o.RENDERBUFFER,I(M),ht,M.width,M.height):o.renderbufferStorage(o.RENDERBUFFER,ht,M.width,M.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,Qt,o.RENDERBUFFER,N)}else{const pt=M.textures;for(let bt=0;bt<pt.length;bt++){const ht=pt[bt],Qt=u.convert(ht.format,ht.colorSpace),Rt=u.convert(ht.type),Nt=z(ht.internalFormat,Qt,Rt,ht.colorSpace);ie(M)?d.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,I(M),Nt,M.width,M.height):q?o.renderbufferStorageMultisample(o.RENDERBUFFER,I(M),Nt,M.width,M.height):o.renderbufferStorage(o.RENDERBUFFER,Nt,M.width,M.height)}}o.bindRenderbuffer(o.RENDERBUFFER,null)}function Gt(N,M,q){const pt=M.isWebGLCubeRenderTarget===!0;if(i.bindFramebuffer(o.FRAMEBUFFER,N),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const bt=s.get(M.depthTexture);if(bt.__renderTarget=M,(!bt.__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),pt){if(bt.__webglInit===void 0&&(bt.__webglInit=!0,M.depthTexture.addEventListener("dispose",G)),bt.__webglTexture===void 0){bt.__webglTexture=o.createTexture(),i.bindTexture(o.TEXTURE_CUBE_MAP,bt.__webglTexture),tt(o.TEXTURE_CUBE_MAP,M.depthTexture);const Vt=u.convert(M.depthTexture.format),Mt=u.convert(M.depthTexture.type);let At;M.depthTexture.format===Ea?At=o.DEPTH_COMPONENT24:M.depthTexture.format===Os&&(At=o.DEPTH24_STENCIL8);for(let Pt=0;Pt<6;Pt++)o.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Pt,0,At,M.width,M.height,0,Vt,Mt,null)}}else lt(M.depthTexture,0);const ht=bt.__webglTexture,Qt=I(M),Rt=pt?o.TEXTURE_CUBE_MAP_POSITIVE_X+q:o.TEXTURE_2D,Nt=M.depthTexture.format===Os?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT;if(M.depthTexture.format===Ea)ie(M)?d.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,Nt,Rt,ht,0,Qt):o.framebufferTexture2D(o.FRAMEBUFFER,Nt,Rt,ht,0);else if(M.depthTexture.format===Os)ie(M)?d.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,Nt,Rt,ht,0,Qt):o.framebufferTexture2D(o.FRAMEBUFFER,Nt,Rt,ht,0);else throw new Error("Unknown depthTexture format")}function le(N){const M=s.get(N),q=N.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==N.depthTexture){const pt=N.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),pt){const bt=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,pt.removeEventListener("dispose",bt)};pt.addEventListener("dispose",bt),M.__depthDisposeCallback=bt}M.__boundDepthTexture=pt}if(N.depthTexture&&!M.__autoAllocateDepthBuffer)if(q)for(let pt=0;pt<6;pt++)Gt(M.__webglFramebuffer[pt],N,pt);else{const pt=N.texture.mipmaps;pt&&pt.length>0?Gt(M.__webglFramebuffer[0],N,0):Gt(M.__webglFramebuffer,N,0)}else if(q){M.__webglDepthbuffer=[];for(let pt=0;pt<6;pt++)if(i.bindFramebuffer(o.FRAMEBUFFER,M.__webglFramebuffer[pt]),M.__webglDepthbuffer[pt]===void 0)M.__webglDepthbuffer[pt]=o.createRenderbuffer(),zt(M.__webglDepthbuffer[pt],N,!1);else{const bt=N.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,ht=M.__webglDepthbuffer[pt];o.bindRenderbuffer(o.RENDERBUFFER,ht),o.framebufferRenderbuffer(o.FRAMEBUFFER,bt,o.RENDERBUFFER,ht)}}else{const pt=N.texture.mipmaps;if(pt&&pt.length>0?i.bindFramebuffer(o.FRAMEBUFFER,M.__webglFramebuffer[0]):i.bindFramebuffer(o.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=o.createRenderbuffer(),zt(M.__webglDepthbuffer,N,!1);else{const bt=N.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,ht=M.__webglDepthbuffer;o.bindRenderbuffer(o.RENDERBUFFER,ht),o.framebufferRenderbuffer(o.FRAMEBUFFER,bt,o.RENDERBUFFER,ht)}}i.bindFramebuffer(o.FRAMEBUFFER,null)}function qe(N,M,q){const pt=s.get(N);M!==void 0&&It(pt.__webglFramebuffer,N,N.texture,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,0),q!==void 0&&le(N)}function ge(N){const M=N.texture,q=s.get(N),pt=s.get(M);N.addEventListener("dispose",P);const bt=N.textures,ht=N.isWebGLCubeRenderTarget===!0,Qt=bt.length>1;if(Qt||(pt.__webglTexture===void 0&&(pt.__webglTexture=o.createTexture()),pt.__version=M.version,h.memory.textures++),ht){q.__webglFramebuffer=[];for(let Rt=0;Rt<6;Rt++)if(M.mipmaps&&M.mipmaps.length>0){q.__webglFramebuffer[Rt]=[];for(let Nt=0;Nt<M.mipmaps.length;Nt++)q.__webglFramebuffer[Rt][Nt]=o.createFramebuffer()}else q.__webglFramebuffer[Rt]=o.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){q.__webglFramebuffer=[];for(let Rt=0;Rt<M.mipmaps.length;Rt++)q.__webglFramebuffer[Rt]=o.createFramebuffer()}else q.__webglFramebuffer=o.createFramebuffer();if(Qt)for(let Rt=0,Nt=bt.length;Rt<Nt;Rt++){const Vt=s.get(bt[Rt]);Vt.__webglTexture===void 0&&(Vt.__webglTexture=o.createTexture(),h.memory.textures++)}if(N.samples>0&&ie(N)===!1){q.__webglMultisampledFramebuffer=o.createFramebuffer(),q.__webglColorRenderbuffer=[],i.bindFramebuffer(o.FRAMEBUFFER,q.__webglMultisampledFramebuffer);for(let Rt=0;Rt<bt.length;Rt++){const Nt=bt[Rt];q.__webglColorRenderbuffer[Rt]=o.createRenderbuffer(),o.bindRenderbuffer(o.RENDERBUFFER,q.__webglColorRenderbuffer[Rt]);const Vt=u.convert(Nt.format,Nt.colorSpace),Mt=u.convert(Nt.type),At=z(Nt.internalFormat,Vt,Mt,Nt.colorSpace,N.isXRRenderTarget===!0),Pt=I(N);o.renderbufferStorageMultisample(o.RENDERBUFFER,Pt,At,N.width,N.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Rt,o.RENDERBUFFER,q.__webglColorRenderbuffer[Rt])}o.bindRenderbuffer(o.RENDERBUFFER,null),N.depthBuffer&&(q.__webglDepthRenderbuffer=o.createRenderbuffer(),zt(q.__webglDepthRenderbuffer,N,!0)),i.bindFramebuffer(o.FRAMEBUFFER,null)}}if(ht){i.bindTexture(o.TEXTURE_CUBE_MAP,pt.__webglTexture),tt(o.TEXTURE_CUBE_MAP,M);for(let Rt=0;Rt<6;Rt++)if(M.mipmaps&&M.mipmaps.length>0)for(let Nt=0;Nt<M.mipmaps.length;Nt++)It(q.__webglFramebuffer[Rt][Nt],N,M,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+Rt,Nt);else It(q.__webglFramebuffer[Rt],N,M,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+Rt,0);y(M)&&v(o.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(Qt){for(let Rt=0,Nt=bt.length;Rt<Nt;Rt++){const Vt=bt[Rt],Mt=s.get(Vt);let At=o.TEXTURE_2D;(N.isWebGL3DRenderTarget||N.isWebGLArrayRenderTarget)&&(At=N.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),i.bindTexture(At,Mt.__webglTexture),tt(At,Vt),It(q.__webglFramebuffer,N,Vt,o.COLOR_ATTACHMENT0+Rt,At,0),y(Vt)&&v(At)}i.unbindTexture()}else{let Rt=o.TEXTURE_2D;if((N.isWebGL3DRenderTarget||N.isWebGLArrayRenderTarget)&&(Rt=N.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),i.bindTexture(Rt,pt.__webglTexture),tt(Rt,M),M.mipmaps&&M.mipmaps.length>0)for(let Nt=0;Nt<M.mipmaps.length;Nt++)It(q.__webglFramebuffer[Nt],N,M,o.COLOR_ATTACHMENT0,Rt,Nt);else It(q.__webglFramebuffer,N,M,o.COLOR_ATTACHMENT0,Rt,0);y(M)&&v(Rt),i.unbindTexture()}N.depthBuffer&&le(N)}function pe(N){const M=N.textures;for(let q=0,pt=M.length;q<pt;q++){const bt=M[q];if(y(bt)){const ht=F(N),Qt=s.get(bt).__webglTexture;i.bindTexture(ht,Qt),v(ht),i.unbindTexture()}}}const Re=[],Ut=[];function Ft(N){if(N.samples>0){if(ie(N)===!1){const M=N.textures,q=N.width,pt=N.height;let bt=o.COLOR_BUFFER_BIT;const ht=N.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,Qt=s.get(N),Rt=M.length>1;if(Rt)for(let Vt=0;Vt<M.length;Vt++)i.bindFramebuffer(o.FRAMEBUFFER,Qt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Vt,o.RENDERBUFFER,null),i.bindFramebuffer(o.FRAMEBUFFER,Qt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+Vt,o.TEXTURE_2D,null,0);i.bindFramebuffer(o.READ_FRAMEBUFFER,Qt.__webglMultisampledFramebuffer);const Nt=N.texture.mipmaps;Nt&&Nt.length>0?i.bindFramebuffer(o.DRAW_FRAMEBUFFER,Qt.__webglFramebuffer[0]):i.bindFramebuffer(o.DRAW_FRAMEBUFFER,Qt.__webglFramebuffer);for(let Vt=0;Vt<M.length;Vt++){if(N.resolveDepthBuffer&&(N.depthBuffer&&(bt|=o.DEPTH_BUFFER_BIT),N.stencilBuffer&&N.resolveStencilBuffer&&(bt|=o.STENCIL_BUFFER_BIT)),Rt){o.framebufferRenderbuffer(o.READ_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.RENDERBUFFER,Qt.__webglColorRenderbuffer[Vt]);const Mt=s.get(M[Vt]).__webglTexture;o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,Mt,0)}o.blitFramebuffer(0,0,q,pt,0,0,q,pt,bt,o.NEAREST),m===!0&&(Re.length=0,Ut.length=0,Re.push(o.COLOR_ATTACHMENT0+Vt),N.depthBuffer&&N.resolveDepthBuffer===!1&&(Re.push(ht),Ut.push(ht),o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,Ut)),o.invalidateFramebuffer(o.READ_FRAMEBUFFER,Re))}if(i.bindFramebuffer(o.READ_FRAMEBUFFER,null),i.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),Rt)for(let Vt=0;Vt<M.length;Vt++){i.bindFramebuffer(o.FRAMEBUFFER,Qt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Vt,o.RENDERBUFFER,Qt.__webglColorRenderbuffer[Vt]);const Mt=s.get(M[Vt]).__webglTexture;i.bindFramebuffer(o.FRAMEBUFFER,Qt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+Vt,o.TEXTURE_2D,Mt,0)}i.bindFramebuffer(o.DRAW_FRAMEBUFFER,Qt.__webglMultisampledFramebuffer)}else if(N.depthBuffer&&N.resolveDepthBuffer===!1&&m){const M=N.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT;o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,[M])}}}function I(N){return Math.min(l.maxSamples,N.samples)}function ie(N){const M=s.get(N);return N.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function Xt(N){const M=h.render.frame;x.get(N)!==M&&(x.set(N,M),N.update())}function Yt(N,M){const q=N.colorSpace,pt=N.format,bt=N.type;return N.isCompressedTexture===!0||N.isVideoTexture===!0||q!==Gr&&q!==as&&(we.getTransfer(q)===Ve?(pt!==Oi||bt!==ui)&&ce("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Le("WebGLTextures: Unsupported texture color space:",q)),M}function Wt(N){return typeof HTMLImageElement<"u"&&N instanceof HTMLImageElement?(p.width=N.naturalWidth||N.width,p.height=N.naturalHeight||N.height):typeof VideoFrame<"u"&&N instanceof VideoFrame?(p.width=N.displayWidth,p.height=N.displayHeight):(p.width=N.width,p.height=N.height),p}this.allocateTextureUnit=j,this.resetTextureUnits=Y,this.setTexture2D=lt,this.setTexture2DArray=U,this.setTexture3D=H,this.setTextureCube=nt,this.rebindTextures=qe,this.setupRenderTarget=ge,this.updateRenderTargetMipmap=pe,this.updateMultisampleRenderTarget=Ft,this.setupDepthRenderbuffer=le,this.setupFrameBufferTexture=It,this.useMultisampledRTT=ie,this.isReversedDepthBuffer=function(){return i.buffers.depth.getReversed()}}function oA(o,t){function i(s,l=as){let u;const h=we.getTransfer(l);if(s===ui)return o.UNSIGNED_BYTE;if(s===jd)return o.UNSIGNED_SHORT_4_4_4_4;if(s===Wd)return o.UNSIGNED_SHORT_5_5_5_1;if(s===cx)return o.UNSIGNED_INT_5_9_9_9_REV;if(s===ux)return o.UNSIGNED_INT_10F_11F_11F_REV;if(s===ox)return o.BYTE;if(s===lx)return o.SHORT;if(s===Qo)return o.UNSIGNED_SHORT;if(s===Xd)return o.INT;if(s===Yi)return o.UNSIGNED_INT;if(s===ki)return o.FLOAT;if(s===ba)return o.HALF_FLOAT;if(s===fx)return o.ALPHA;if(s===hx)return o.RGB;if(s===Oi)return o.RGBA;if(s===Ea)return o.DEPTH_COMPONENT;if(s===Os)return o.DEPTH_STENCIL;if(s===dx)return o.RED;if(s===qd)return o.RED_INTEGER;if(s===Hr)return o.RG;if(s===Yd)return o.RG_INTEGER;if(s===Zd)return o.RGBA_INTEGER;if(s===Vc||s===kc||s===Xc||s===jc)if(h===Ve)if(u=t.get("WEBGL_compressed_texture_s3tc_srgb"),u!==null){if(s===Vc)return u.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===kc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===Xc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===jc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(u=t.get("WEBGL_compressed_texture_s3tc"),u!==null){if(s===Vc)return u.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===kc)return u.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===Xc)return u.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===jc)return u.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===ld||s===cd||s===ud||s===fd)if(u=t.get("WEBGL_compressed_texture_pvrtc"),u!==null){if(s===ld)return u.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===cd)return u.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===ud)return u.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===fd)return u.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===hd||s===dd||s===pd||s===md||s===gd||s===_d||s===xd)if(u=t.get("WEBGL_compressed_texture_etc"),u!==null){if(s===hd||s===dd)return h===Ve?u.COMPRESSED_SRGB8_ETC2:u.COMPRESSED_RGB8_ETC2;if(s===pd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:u.COMPRESSED_RGBA8_ETC2_EAC;if(s===md)return u.COMPRESSED_R11_EAC;if(s===gd)return u.COMPRESSED_SIGNED_R11_EAC;if(s===_d)return u.COMPRESSED_RG11_EAC;if(s===xd)return u.COMPRESSED_SIGNED_RG11_EAC}else return null;if(s===vd||s===Sd||s===yd||s===Md||s===bd||s===Ed||s===Td||s===Ad||s===Rd||s===Cd||s===wd||s===Dd||s===Nd||s===Ud)if(u=t.get("WEBGL_compressed_texture_astc"),u!==null){if(s===vd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:u.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===Sd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:u.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===yd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:u.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===Md)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:u.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===bd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:u.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===Ed)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:u.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===Td)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:u.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===Ad)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:u.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===Rd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:u.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===Cd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:u.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===wd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:u.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===Dd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:u.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===Nd)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:u.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===Ud)return h===Ve?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:u.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===Ld||s===Od||s===Pd)if(u=t.get("EXT_texture_compression_bptc"),u!==null){if(s===Ld)return h===Ve?u.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:u.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===Od)return u.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===Pd)return u.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===zd||s===Fd||s===Id||s===Bd)if(u=t.get("EXT_texture_compression_rgtc"),u!==null){if(s===zd)return u.COMPRESSED_RED_RGTC1_EXT;if(s===Fd)return u.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===Id)return u.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===Bd)return u.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===Jo?o.UNSIGNED_INT_24_8:o[s]!==void 0?o[s]:null}return{convert:i}}const lA=`
void main() {
